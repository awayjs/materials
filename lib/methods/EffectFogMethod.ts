...
export class _Shader_EffectFogMethod extends _Shader_MethodBase {
	...
	public _activate(): void {
		if (this._invalid) {
			...
			const index: number = this._fogColorIndex;
			const color: number = this._method.fogColor;
	...
	public _getFragmentCode(targetReg: ShaderRegisterElement, registerCache: ShaderRegisterCache, sharedRegisters: ShaderRegisterData): string {
		const fogColor: ShaderRegisterElement = registerCache.getFreeFragmentConstant();
		const fogData: ShaderRegisterElement = registerCache.getFreeFragmentConstant();
