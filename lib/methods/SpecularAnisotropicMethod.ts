...
/**
 * SpecularAnisotropicMethod provides a specular method resulting in anisotropic
 * highlights. These are typical for surfaces with microfacet details such as
 * tiny grooves. In particular, this uses the Heidrich-Seidel distrubution. The
 * tangent vectors are used as the surface groove directions.
 */
...
/**
 * _Shader_SpecularAnisotropicMethod provides a specular method resulting in
 * anisotropic highlights. These are typical for surfaces with microfacet
 * details such as tiny grooves. In particular, this uses the Heidrich-Seidel
 * distrubution. The tangent vectors are used as the surface groove directions.
 */
