...
export class _Shader_EffectColorMatrixMethod extends _Shader_MethodBase {
	...
	public _getFragmentCode(targetReg: ShaderRegisterElement, registerCache: ShaderRegisterCache, sharedRegisters: ShaderRegisterData): string {
		...
		const colorOffsetReg: ShaderRegisterElement = registerCache.getFreeFragmentConstant();
	...
	public _activate(): void {
		if (this._invalid) {
			const matrix: Array<number> = this._method.matrix;
			const index: number = this._colorMatrixIndex;
