...
/**
 * SpecularCompositeMethod provides a base class for specular methods that wrap
 * a specular method to alter the calculated specular reflection strength.
 */
export class SpecularCompositeMethod extends CompositeMethodBase {
	 ...
	 * base method's strength. It needs to have the signature
	 * clampDiffuse(t:ShaderRegisterElement,
	 * regCache:ShaderRegisterCache):string, in which t.w will contain the
	 * diffuse strength.
	 * @param baseMethod The base specular method on which this method's shading
	 * is based.
	 */
