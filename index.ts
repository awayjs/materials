export {MethodVO}						from "./lib/data/MethodVO";
...
export {DiffuseDepthMethod}				from "./lib/methods/DiffuseDepthMethod";
...
export {DiffuseSubSurfaceMethod}			from "./lib/methods/DiffuseSubSurfaceMethod";
...
export {EffectMethodBase}				from "./lib/methods/EffectMethodBase";
...
export {LightingMethodBase}				from "./lib/methods/LightingMethodBase";
...
export {ShadowMapMethodBase}				from "./lib/methods/ShadowMapMethodBase";
...
export {SingleObjectDepthPass}			from "./lib/surfaces/passes/SingleObjectDepthPass";
